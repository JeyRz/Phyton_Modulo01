...
def main():
    ...
    try:
        while ciclo == True:
            ...
            print(' '*5 , " 7. Exportar tarjetas a JSON", ' '*5)
            print(' '*5 , " 8. Importar tarjetas de archivo JSON", ' '*5)
            print(' '*5 , " 9. Exportar tarjetas a CSV", ' '*5)
            print(' '*5 , " 10. Importar tarjetas de archivo CSV", ' '*5)
            print(' '*5 , " 11. Salir ", ' '*5)
            print('-'*60)
            ...
            if opcion == 1:
                ...
                print("")
                tarjeta_borrar = input("Si desea borrar todas (Todas) o digite el nombre de la tarjeta: ")
                if tarjeta_borrar == "Todas":
                    pass
                else:
                ...
                print("")
                print("¡Exportando tarjetas! ...")
                usuario.exportar_tarjetas_json()
            
            elif opcion == 8:
                print("")
                print("¡Importantdo tarjetas! ...")
                usuario.importar_de_json()
                usuario.guardarTarjetasDB()

            elif opcion == 9:
                print()
                usuario.guarda_tarjeta_csv()
            
            elif opcion == 10:
                print()
                usuario.importar_de_csv()
                usuario.guardarTarjetasDB()
