...
class Usuario():
    ...
    def guarda_tarjeta_csv(self): # ruta al archivo donde voy a a guardar los resulados
        ...
        #print("datos: ", datos)
        with open(NOMBRE_CSV, "w", newline="", encoding="utf-8" ) as arch_texto: 
        ...
        self.__log_de_usuario(f"El usuario exporto tarjetas al archivo {NOMBRE_CSV}")

    def importar_de_csv(self):
        """ Importa la lista de tarjetas desde un archivo en formato JSON """
        registro = 0
        with open(NOMBRE_CSV, 'r', encoding='utf-8') as arch_txt:
        ...
        self.__log_de_usuario(f"El usuario importó tarjetas del archivo {NOMBRE_CSV}")
    ...
    def __log_de_usuario(self, texto): # ruta al archivo donde voy a a guardar los resulados
        ...
        with open(NOMBRE_TXT, "a", encoding="utf-8" ) as arch_texto: 
            # w operación de escritura # a arbre el archivo y los agrega al final de los que ya existen
            #for elemento in lista: #lista -> [Archivo, Carpeta(), ...]
