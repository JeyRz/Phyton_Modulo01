class Tarjeta():
    ...
    def __str__(self):
        return f"({self.__nombre:>3}) {self.__tasa:>10} {self.__deuda:>3.0f} {self.__pago:>10.2f}"

    def __deepcopy__(self): 
        """ Devuelve una copia de la propia tarjeta"""
        return self.copy()
    ...
    def tupla_tarjeta(self):
        "Crea la tarjeta en formato tupla para insertar a la BD"
    ...
    def tupla_to_dict(self, tupla):
        """ Obtiente una tupla y la devuelve como diccionario """
        diccionario_tarjeta = {'Nombre': tupla[0], 'Tasa':tupla[1], 'Deuda': tupla[2], \
            'Pago': tupla[3], 'N_cargos': tupla[4], 'T_recalculada': tupla[5], \
            'T_mensual': tupla[6], 'N_deuda' : tupla[7] }    
        return diccionario_tarjeta
